...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InstrumentHistory.condition'
        db.add_column('instruments_instrumenthistory', 'condition', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'InstrumentHistory.notes'
        db.add_column('instruments_instrumenthistory', 'notes', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InstrumentHistory.condition'
        db.delete_column('instruments_instrumenthistory', 'condition')

        # Deleting field 'InstrumentHistory.notes'
        db.delete_column('instruments_instrumenthistory', 'notes')
    ...
    models = {
        ...
        'instruments.instrumenthistory': {
            ...
            'condition': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
